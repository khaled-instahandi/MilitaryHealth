...
{
    [ApiController]
    [Route("api/OrthopedicExams")]
    //[Authorize]
    public class OrthopedicExamsController : ControllerBase
    {
        private readonly IMediator _mediator;

        public OrthopedicExamsController(IMediator mediator)
        {
            _mediator = mediator;
        }
        ...
        {
            Expression<Func<OrthopedicExam, bool>>? filterExpr = null;
            ...
            var query = new GetEntitiesQuery<OrthopedicExam, OrthopedicExamDto>(
                filterExpr,
                null,
                sortBy,
                sortDesc,
                ...
                pageSize
                ,
                    new Expression<Func<OrthopedicExam, object>>[] { b => b.Result, c => c.Doctor }
